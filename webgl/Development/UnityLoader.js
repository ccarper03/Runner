...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 5554944;
      var PACKAGE_UUID = 'f0dca5aa-0889-46fb-a3dc-92357b6663f3';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 18, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(18, 2220398, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(2220398, 2220812, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(2220812, 2224187, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(2224187, 4031259, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4031259, 5527319, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5527319, 5554944, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
